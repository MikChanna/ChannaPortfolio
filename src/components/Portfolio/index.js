...
function Portfolio (){
    ...
    <div className="portfolioContainer">
          ...
          <div className = "section__item--porfolio">
              <img src = "../Images/stock.jpg" alt = "instock demo" className = "section__img--portfolio"/>
          ...
          <div className = "section__item--porfolio">
            <img src = "../Images/BurgerApp.jpg" alt = "burgerapp demo" className = "section__img--portfolio"/>
          ...
          <div className = "section__item--porfolio">
            <img src = "../Images/jinji.jpg" alt = "jinji demo" className = "section__img--portfolio"/>
